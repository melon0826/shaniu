...
func TestEnsureNodeShaniuModuleWritesRuntimeFiles(t *testing.T) {
	...
	for _, name := range []string{
		...
		filepath.Join("node_modules", "shaniu", "srpc.js"),
		filepath.Join("node_modules", "shaniu", "shaniu.d.ts"),
		filepath.Join("node_modules", "shaniu", "package.json"),
		filepath.Join("node_modules", "shaniu.d.ts"),
	} {
