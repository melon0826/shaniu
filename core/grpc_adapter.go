...
func (sg *ShaniuService) AdapterRegist(stream srpc.ShaniuService_AdapterRegistServer) error {
	var adapter *Factory
	var echos sync.Map
	// defer func() {
...
func (sg *ShaniuService) AdapterReceive(ctx context.Context, req *srpc.AdapterRequest) (*srpc.Empty, error) {
...
func (sg *ShaniuService) AdapterPush(ctx context.Context, req *srpc.AdapterRequest) (*srpc.Default, error) {
...
func (sg *ShaniuService) AdapterDestroy(ctx context.Context, req *srpc.AdapterRequest) (*srpc.Empty, error) {
	bot_id := req.GetBotId()
	platform := req.GetPlatform()
	adapter, err := GetAdapter(platform, bot_id)
	if err == nil {
