...
func TestParseGithubPublicFileIndexReadsDependenciesField(t *testing.T) {
  ...
  "fbd8dead-f6ca-56e8-8293-d7980d1bbf91": {
    ...
    "raw": "https://raw.githubusercontent.com/melon0826/shaniu_Plugins/main/plugins/getPrinterStatus.js",
    "dependencies": ["ipp", "axios", "node:fs", "shaniu", "ipp"],
    "type": "node",
    "origin": "https://github.com/melon0826/shaniu_Plugins"
  }
}`)
...
func TestGithubPublicFileIndexPythonPlugin(t *testing.T) {
  ...
  "plugins/pythonDemo.py": {
    ...
    "raw": "https://raw.githubusercontent.com/melon0826/shaniu_Plugins/main/plugins/pythonDemo.py",
