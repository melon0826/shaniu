...
declare class SchemaNode implements ShaniuSchemaNode {
    __schemaNode: boolean;
    schema: Record<string, any>;
...
export { Adapter, Bucket, QingLong, YybGo, DaiDai, shaniuCreateSchema, ShaniuPluginConfig, form, pluginConfigDefaults, sender, pushAdmin, sleep, version, restart, update, utils, console, };
