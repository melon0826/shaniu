...
export namespace srpc {
    ...
    export abstract class UnimplementedShaniuServiceService {
        static definition = {
            BucketGet: {
    ...
    export class ShaniuServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedShaniuServiceService.definition, "ShaniuService", {}) {
